  ...
  return (
    <>
        ...
        <div className='flex justify-between max-w-[1300px] mx-auto my-2 items-center'>
            <div>
                <h3 className='font-bold text-2xl'> {toggle ?" Available Players " : "Selected players ( "  +   purchasePLayer.length + ')' }</h3>
            </div>
            <div className='   '>
        ...
        
        {
          toggle ? <div className='flex justify-center items-center'>
                      <Suspense  fallback = {<span className="  loading loading-spinner loading-lg  "></span>}>
                        <Availableplayers purchasePLayer={purchasePLayer} setPurchasePLayer={setPurchasePLayer} fetchplayersPromise={fetchplayersPromise} ></Availableplayers>
                      </Suspense>
                    </div>
                    :
                    <SelectedPlayers purchasePLayer={purchasePLayer} setPurchasePLayer={setPurchasePLayer} ></SelectedPlayers>
        }
